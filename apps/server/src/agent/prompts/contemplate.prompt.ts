...
export function buildContemplatePrompt(records: Record[], topics: Topic[], taskId: string, currentTime = nowIso()): string {
...
- create_topic(title, summary, tags, content): 创建新 topic
- update_topic(topicId, title?, summary?, tags?, content?): 更新已有 topic
